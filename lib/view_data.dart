...
class _view_dataState extends State<view_data> {
  ...
  Future get_data()
  async {
    var url = Uri.parse('https://systudent1.000webhostapp.com/view_data_api.php');
            ...
            return ListView.builder(itemCount: l.length,itemBuilder: (context, index) {
              return ListTile(
               title: Text("${l[index]['name']}"),
                leading: CircleAvatar(backgroundImage: NetworkImage("https://systudent1.000webhostapp.com/${l[index]['image']}")),
                        ...
                        return AlertDialog(title: Text("are you sure for delete..."),
                          actions: [
                            ...
                            TextButton(onPressed: () async {
                              var url = Uri.parse('https://systudent1.000webhostapp.com/delete_api.php?id=${l[index]['id']}');
                              var response = await http.get(url);
                              print(response.body);
                              Navigator.pop(context);
                              setState(() {
