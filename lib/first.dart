      ...
      body: Column(
        children: [
          ...
          ElevatedButton(onPressed: () async {
            ...
            if(widget.l!=null)
              {
                 url = Uri.parse('https://systudent1.000webhostapp.com/add_api.php?name=$name&contact=$contact&city=$city&image=$image &id=${widget.l['id']}');

              }
            else
              {
                url = Uri.parse('https://systudent1.000webhostapp.com/add_api.php');
